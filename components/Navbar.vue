  ...
  <nav class="border-neutral-200">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
      <nuxt-link to="/" class="flex items-center space-x-3 rtl:space-x-reverse">
        <img src="/public/img/logo.webp" class="h-8" alt="Flowbite Logo" />
      </nuxt-link>
      <button
          @click="toggleMenu"
          type="button"
          class="inline-flex items-center p-2 w-10 h-10 justify-center text-sm rounded-lg md:hidden focus:outline-none focus:ring-2 text-neutral-400 hover:bg-neutral-700 focus:ring-neutral-600"
      ...
      <div :class="{'block': isMenuOpen, 'hidden': !isMenuOpen}" class="w-full md:block md:w-auto" id="navbar-default">
        <div class="absolute w-11/12 md:relative md:w-full">
          <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border rounded-lg md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 bg-neutral-800 md:bg-transparent border-neutral-700">
            <li>
              <nuxt-link to="/" class="block py-2 px-3 bg-white rounded md:bg-transparent md:p-0 text-black md:text-neutral-400" aria-current="page">Accueil</nuxt-link>
            </li>
            <li>
